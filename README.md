...
## iOS アプリのビルドや動作確認について

macOS の PC を持っていなければ、iOS アプリのビルドや動作確認をすることは困難です。 
不可能ではありませんが、課題で確認したいポイントとは少しずれるため、あまりここに時間を費やす必要はありません。

もし macOS の PC がないなどで iOS アプリのビルドや動作確認をすることが困難な場合は、提出の際に理由も合わせてご連絡ください。
その場合は、レビュー対象から iOS アプリのビルドや動作については除外させていただきます。
